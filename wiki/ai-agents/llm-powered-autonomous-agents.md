...
- [ReAct: Synergizing Reasoning and Acting in Language Models](react-reasoning-acting.md) — 本框架 Planning 组件的核心方法。
- [Reflexion: Language Agents with Verbal Reinforcement Learning](reflexion.md) — 本框架自我反思 + 记忆的代表。
- [Toolformer: Language Models Can Teach Themselves to Use Tools](toolformer.md) — 本框架 Tool use 的训练时路线。
